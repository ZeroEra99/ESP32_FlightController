...
const unsigned long TIMEOUT_THRESHOLD = 200000; // 200 ms
...
{
  unsigned long age = micros() - isr_age[my_isr];
  if (age > TIMEOUT_THRESHOLD)
  {
    return 0; // Segnale interrotto, restituisci 0
  }
...
{
  // Restituisce il tempo in microsecondi dall'ultima misurazione valida
